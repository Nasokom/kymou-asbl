...
export const PROJECT_QUERY = defineQuery(`*[_type == "projectv2" && slug.current == $slug][0]
                    ...
                    slug,
                    pitch{text,"image":image.asset->,"video":video.asset->url},
                    problem{text,"image":image.asset->,"video":video.asset->url},
                    action{text,"image":image.asset->,"video":video.asset->url},
                    result{text,"image":image.asset->,"video":video.asset->url},
