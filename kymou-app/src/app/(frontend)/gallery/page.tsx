...
export default async function Page(){
  ...
  return (
    <div className='min-h-[100dvh] w-[100vw] relative flex flex-col gap-4 mt-[50px] items-center pt-8 p-2'>
        <h1 className={'font-rec2 text-9xl max-[800px]:text-[25vw] fixed overflow-hidden pb-2'}>
      ...
      <h2 className={'font-rec2 fixed top-[50vh] w-full leading-none text-center text-6xl  max-[800px]:text-4xl overflow-hidden '}>
