  ...
  return (
    ...
    >
        ...
        <Link href={'/blog/'+data.slug.current} className='w-full flex gap-4 bg-[white] min-h-[30vw] min-h-fit rounded-xl  overflow-hidden'>
            ...
            <div className='relative w-full h-[100] w-[50%]'>
            ...
            <div className='w-[50%] max-w-[50%] flex-auto flex flex-col justify-center pt-4 p-2 gap-4'>
                ...
                <div className='w-full flex justify-end'>
                    <button className='bg-[--color1]  hover:bg-[--color3] hover:zigzagsm hover:text-white transition p-4 w-fit rounded-xl font-rec1'>Decouvrir</button>
